...
💻 **Web Developer | AI & LLM Enthusiast | Tinkerer**

I’m an undergrad engineer who enjoys building things end to end from **web apps and APIs** to  **AI powered tools and hardware experiments** . I’m especially interested in  **LLMs, accessibility tech, and developer tooling** , and I love exploring how software and hardware intersect.
...
* Systems & performance-oriented engineering
* Electronics, IoT & hardware prototyping
...
![img](https://nirzak-streak-stats.vercel.app/?user=jvn321&theme=transparent&hide_border=false)

<!-- Created with the help from GPRM ( https://gprm.itsvg.in ) -->
